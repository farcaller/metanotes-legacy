...
function CoreEvents({ children }: { children: ReactNode }): JSX.Element {
  ...
  return (
    <CoreEventsContext.Provider value={handlers}>
      {children}
    </CoreEventsContext.Provider>
  );
}

export default React.memo(CoreEvents);
