...
/* attributes *
 * id: 01EWDEMAP9TR0MNYB97RVBXWGT
 * content-type: application/vnd.metanotes.component-jsmodule
 * title: $:core/parser/EmphasisUnderline
 * tags: ['$:core/parser']
 * parser: EmphasisUnderline
 */

const {
  notFollowedBy, Parser, makeSuccess, makeFailure,
...
const opening = Parser((input, i) => {
  ...
  return makeFailure(i, 'not opening _');
});
...
const closing = Parser((input, i) => {
  ...
  return makeFailure(i, 'not closing _');
});
...
export default EmphasisUnderline;
